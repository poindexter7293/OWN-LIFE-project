...
CREATE TABLE `weight_log` (
  `weight_log_id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `uk_weight_member_date` (`member_id`,`log_date`),
  KEY `idx_weight_member_date` (`member_id`,`log_date`),
  CONSTRAINT `fk_weight_log_member` FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`) ON DELETE CASCADE
